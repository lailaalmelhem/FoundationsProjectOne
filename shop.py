...
############################# Start Here! ##############################
cupcake_shop_name = "carolina_cupcakes"
signature_flavors = ["oreo", "mocha", "funfetti"]
order_list = []
...
def print_order(order_list):
    ...
    # your code goes here!
    print (order_list) 
    print ("Your final order is %s" % order_list)
